...
# 활용가이드 별첨의 정류장 코드 중 여객터미널 정류장만. API는 T2 정류장 둘을 같은
# 이름으로 주지만, 노선 대조로 위치를 특정했다: 10000160은 T1(8번)과 같은 배차
# (공항04 → T2 3층 6번), 10000180은 T1(동)·(서)와 같은 배차(공항03 → T2 3층 7번).
SHUTTLE_STOPS: dict[str, tuple[str, str]] = {
    "10000150": ("T1", "제1여객터미널(8번)"),
    "10000200": ("T1", "제1여객터미널(동)"),
    "10000210": ("T1", "제1여객터미널(서)"),
    "10000160": ("T2", "제2여객터미널(3층 6번)"),
    "10000180": ("T2", "제2여객터미널(3층 7번)"),
}
